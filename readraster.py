...
#reshaping numpy array into a table with 16 columns and 1250*1250 rows
    all_data=all_data.reshape(16,1250*1250).T
...
#make np array dataframe
    ...
    "MSRM","POINT_X","POINT_Y","MED"])
#prediction data has to have the same column order as in the model
    cols=['POINT_X', 'POINT_Y', 'CVA', 'SDFS', 'Rugged', 'DFME', 'MSRM', 'MED', 'EAS1ha', 'EAS10ha', 'DEM', 'DI2m', 'LandAge', 'SoilDepth', 'HKDepth', 'NMD']
...
#set parameters for xgboost model
    param = {'learning_rate': 0.3, 'max_depth' : 15, 'objective':'multi:softmax', 'subsample':0.5, 'n_estimators':2000,
