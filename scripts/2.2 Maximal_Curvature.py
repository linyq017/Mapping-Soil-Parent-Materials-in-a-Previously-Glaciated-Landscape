...
def maximal_curvature(input_path, output_path):
    """Apply maximal curvature tool to each .tif file in the input directory."""
    ...
    for tif_file in tif_files:
        ...
        try:
            # Apply the maximal curvature tool
...
if __name__ == '__main__':
    ...
    maximal_curvature(args.input_path, args.output_path)
